...
describe('Open logs command', function () {
  beforeEach(function () {
    setupMocks();
  ...
  describe('With project, authenticated', function () {
    ...
    it('should open the logs page as json', async function () {
      const out = await runCommand(['open-logs', '--json']);
      expect(out.stdout).to.contain('https://console.cloud.google.com/logs/viewer');
    });
  });
});
