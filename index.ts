 ...
 */
function login(useLocalhost: boolean) {
 ...
 */
async function create(title: string = LOG.UNTITLED_SCRIPT_TITLE, parentId: string) {
 ...
 */
async function clone(scriptId: string) {
  await checkIfOnline();
 ...
 */
function openScriptProject(scriptId: string) {
 ...
 */
function deploy(version: string, description: string) {
 ...
 */
function undeploy(deploymentId: string) {
   getAPICredentials(async () => {
     await checkIfOnline();
     getProjectSettings().then(({ scriptId }: ProjectSettings) => {
       if (!scriptId) return;
 ...
 */
function redeploy(deploymentId: string, version: string, description: string) {
  getAPICredentials(async () => {
    await checkIfOnline();
    getProjectSettings().then(({ scriptId }: ProjectSettings) => {
